...
class Football(Extension):
    ...
    async def matchday_function(
        self,
        ctx: SlashContext,
        liga: str = LEAGUE_CHOICES[0].value,
    ...
    async def matches_function(
        self, ctx: SlashContext, team: str = "Werder Bremen", past: int = 2, future: int = 2
    ):
